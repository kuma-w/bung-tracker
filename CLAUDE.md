...
`content`는 공백으로 토큰을 분리한 뒤, 각 토큰을 **날짜 패턴**으로 먼저 판별하고, 매칭되지 않으면 **이름**으로 분류한다.

**날짜 패턴 (올해 연도 자동 적용)**

| 패턴 | 예시 | 변환 결과 |
|------|------|-----------|
| `YYYY-MM-DD` | `2026-04-17` | `2026-04-17` (그대로) |
| `M/DD`, `MM/DD` | `4/17`, `04/17` | `2026-04-17` |
| `M-DD`, `MM-DD` | `4-17`, `04-17` | `2026-04-17` |
| `M.DD`, `MM.DD` | `4.17`, `04.17` | `2026-04-17` |
| `MMDD` (4자리) | `0417` | `2026-04-17` |
| `MDD` (3자리) | `417` | `2026-04-17` |
...
| `홍길동 0417 0424` | `["홍길동"]` | `["2026-04-17", "2026-04-24"]` |
| `홍길동 4/17` | `["홍길동"]` | `["2026-04-17"]` |
| `홍길동 4.17` | `["홍길동"]` | `["2026-04-17"]` |

**파싱 실패 케이스**

- 이름만 있고 날짜 없음 → `status: failed`, `422` 반환
- 날짜만 있고 이름 없음 → `status: failed`, `422` 반환
